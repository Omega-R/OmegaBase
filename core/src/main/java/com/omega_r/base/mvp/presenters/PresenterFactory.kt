...
class PresenterFactory<P : MvpPresenter<*>>(tag: String, clz: Class<out MvpPresenter<*>>, private val factoryBlock: () -> P) :
...
inline fun <reified P : MvpPresenter<*>> MvpDelegateHolder.providePresenter(
    ...
    return PresenterFactory(P::class.java.name + "." + name, P::class.java, factoryBlock).also {
