...
class Constants {
    ...
    companion object {
        ...
        internal val CLASS_NAME_BASE_OMEGA_REPOSITORY = ClassName.bestGuess("com.omega_r.base.data.OmegaBaseRepository")
        ...
        internal val REMOTE_ELSE_CACHE = "com.omega_r.base.data.OmegaRepository.Strategy.REMOTE_ELSE_CACHE"
